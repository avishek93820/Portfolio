...
export function ProjectModal({ project, onClose }: ProjectModalProps) {
  ...
  return (
    <>
      ...
      <div
        className="fixed inset-4 md:inset-auto md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 z-[81] md:w-full md:max-w-2xl max-h-[90vh] overflow-y-auto glass rounded-2xl p-6 md:p-8"
        role="dialog"
        aria-modal="true"
      ...
      >
        ...
        <h3
          ...
          className="font-display text-2xl font-bold mb-3 pr-10"
        >
          {project.title}
        </h3>
