      ...
      <div className="container-narrow relative z-10 grid lg:grid-cols-[1fr_1.2fr] gap-12 lg:gap-16 items-center">
        ...
        >
          <div className="relative">
            <div className="absolute inset-0 rounded-full bg-gradient-to-br from-cyan-500/20 via-violet-500/20 to-fuchsia-500/20 blur-lg scale-105" />

            <div className="relative w-48 h-48 sm:w-56 sm:h-56 md:w-64 md:h-64 rounded-full p-1 bg-gradient-to-br from-cyan-400 via-violet-500 to-fuchsia-500">
            ...
            <div className="absolute -bottom-2 -right-2 px-3 py-1.5 rounded-full glass text-xs font-mono text-cyan-400 border border-cyan-500/30">
        ...
        >
          ...
          <p className="text-lg sm:text-xl text-[var(--color-muted)] mb-2">
            {PERSONAL.headline}
          </p>
